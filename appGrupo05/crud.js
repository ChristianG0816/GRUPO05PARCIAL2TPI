...
var fila =
  "<tr><td class='id'></td><td class='Nombre'></td><td class='Descripcion'></td><td class='price'></td> <td class='imagen'></td><td class='Video'></td><td class='Categoria'></td><td class='Opciones'></td></tr>";
var productos = null;
...
function listarProductos(productos) {
  ...
  update = document.getElementsByClassName("Opciones");
  ...
  for (nfila = 0; nfila < num; nfila++) {
    ...
    borrar[nfila].lastChild.setAttribute(
      "href",
